 ...
 * @since 1.0
 */
public interface IObserver extends ISchemaElement, ICloneable {
     ...
     */
    String XML_ELEMENT_OBSERVER = "observer";

    /**
     * Constant for XML representation: Observers name element name.<br>
     * Example:<br>
     * &lt;observer&gt; <br>
     * <i>More stuff goes here</i> &lt;name&gt;<code>Observer name goes here</code>&lt;/name&gt; <i>More stuff goes
     * here</i> &lt;/observer&gt;
     */
     ...
     * Example:<br>
     * &lt;observer&gt; <br>
     * <i>More stuff goes here</i> &lt;surname&gt;<code>Observer surname goes here</code>&lt;/surname&gt; <i>More stuff
     * goes here</i> &lt;/observer&gt;
     */
    String XML_ELEMENT_SURNAME = "surname";

    /**
     * Constant for XML representation: Observers contact element name.<br>
     * Example:<br>
     * &lt;observer&gt; <br>
     * <i>More stuff goes here</i> &lt;contact&gt;<code>Observer contact data goes here</code>&lt;/contact&gt; <i>More
     * stuff goes here</i> &lt;/observer&gt;
     */
    String XML_ELEMENT_CONTACT = "contact";
     ...
     * Example:<br>
     * &lt;observer&gt; <br>
     * <i>More stuff goes here</i> &lt;fstOffset&gt;<code>Observer fst value goes here</code>&lt;/fstOffset&gt; <i>More
     * stuff goes here</i> &lt;/observer&gt;
     */
    String XML_ELEMENT_FST_OFFSET = "fstOffset";
     ...
     */
    @Deprecated
    void setDSLCode(String DSLCode);
     ...
     */
    void setSurname(String surname) throws IllegalArgumentException;
     ...
     */
    void setFSTOffset(float fstOffset);
