...
public enum Constellation {
    ...
    CAPRICORNUS("Cap", "Capricornus"), CARINA("Car", "Carina"), CASSIOPEIA("Cas", "Cassiopeia"),
    CENTAURUS("Cen", "Centaurus"), CEPHEUS("Cep", "Cepheus"), CETUS("Cet", "Cetus"), CHAMAELEON("Cha", "Chamaeleon"),
    CIRCINUS("Cir", "Circinus"), COLUMBA("Col", "Columba"), COMA_BERENICES("Com", "Coma Berenices"),
    CORONA_AUSTRALIS("CrA", "Corona Australis"), CORONA_BOREALIS("CrB", "Corona Borealis"), CORVUS("Crv", "Corvus"),
    CRATER("Crt", "Crater"), CRUX("Cru", "Crux"), CYGNUS("Cyg", "Cygnus"), DELPHINUS("Del", "Delphinus"),
    DORADO("Dor", "Dorado"), DRACO("Dra", "Draco"), EQUULEUS("Equ", "Equuleus"), ERIDANUS("Eri", "Eridanus"),
    FORNAX("For", "Fornax"), GEMINI("Gem", "Gemini"), GRUS("Gru", "Grus"), HERCULES("Her", "Hercules"),
    HOROLOGIUM("Hor", "Horologium"), HYDRA("Hya", "Hydra"), HYDRUS("Hyi", "Hydrus"), INDUS("Ind", "Indus"),
    LACERTA("Lac", "Lacerta"), LEO("Leo", "Leo"), LEO_MINOR("LMi", "Leo Minor"), LEPUS("Lep", "Lepus"),
    LIBRA("Lib", "Libra"), LUPUS("Lup", "Lupus"), LYNX("Lyn", "Lynx"), LYRA("Lyr", "Lyra"), MENSA("Men", "Mensa"),
    MICROSCOPUS("Mic", "Microscopus"), MONOCERUS("Mon", "Monocerus"), MUSCA("Mus", "Musca"), NORMA("Nor", "Norma"),
    OCTANS("Oct", "Octans"), OPHIUCHUS("Oph", "Ophiuchus"), ORION("Ori", "Orion"), PAVO("Pav", "Pavo"),
    PEGASUS("Peg", "Pegasus"), PERSEUS("Per", "Perseus"), PHOENIX("Phe", "Phoenix"), PICTOR("Pic", "Pictor"),
    PISCES_AUSTRINUS("PsA", "Pisces Austrinus"), PISCES("Psc", "Pisces"), PUPPIS("Pup", "Puppis"),
    PYXIS("Pyx", "Pyxis"), RETICULUM("Ret", "Reticulum"), SAGITTA("Sge", "Sagitta"), SAGITTARIUS("Sgr", "Sagittarius"),
    SCORPIUS("Sco", "Scorpius"), SCULPTOR("Scl", "Sculptor"), SCUTUM("Sct", "Scutum"), SERPENS("Ser", "Serpens"),
    SEXTANS("Sex", "Sextans"), TAURUS("Tau", "Taurus"), TELESCOPIUM("Tel", "Telescopium"),
    TRIANGULUM_AUSTRALIS("TrA", "Triangulum Australis"), TRIANGULUM("Tri", "Triangulum"), TUCANA("Tuc", "Tucana"),
    URSA_MAIOR("UMa", "Ursa Maior"), URSA_MINOR("UMi", "Ursa Minor"), VELA("Vel", "Vela"), VIRGO("Vir", "Virgo"),
    VOLANS("Vol", "Volans"), VULPECULA("Vul", "Vulpecula");
    // @formatter:on
