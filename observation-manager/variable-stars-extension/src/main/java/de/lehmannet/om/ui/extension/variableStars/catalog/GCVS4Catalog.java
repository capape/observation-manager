...
public class GCVS4Catalog implements ICatalog {
    ...
    private int searchByName(String objectName) {
        ...
        } else if (constellation.equals(Constellation.MONOCEROS)) {
            lines = GCVS4Catalog.LINES_MONOCEROS;
        ...
        } else if (constellation.equals(Constellation.PISCIS_AUSTRINUS)) {
            lines = GCVS4Catalog.LINES_PISCIS_AUSTRINUS;
        ...
        } else if (constellation.equals(Constellation.URSA_MAJOR)) {
            lines = GCVS4Catalog.LINES_URSA_MAJOR;
