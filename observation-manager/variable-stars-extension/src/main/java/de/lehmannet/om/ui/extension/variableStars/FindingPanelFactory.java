...
public final class FindingPanelFactory {

    private FindingPanelFactory() {
    ...
    public static AbstractPanel newInstance(IExtensionContext extensionContext, String xsiType, IFinding finding,
        ...
        switch (xsiType) {
            ...
            case FindingVariableStar.XML_XSI_TYPE_VALUE:
                return new VariableStarFindingPanel(extensionContext.getConfiguration(), (FindingVariableStar) finding,
                        session, target, editable);
