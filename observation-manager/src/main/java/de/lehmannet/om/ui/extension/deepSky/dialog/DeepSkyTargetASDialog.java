...
public class DeepSkyTargetASDialog extends AbstractDialog implements ITargetDialog {
    ...
    public DeepSkyTargetASDialog(ObservationManager om, ObservationManagerModel model, ITarget editableTarget) {

        super(om, new DeepSkyTargetASPanel(om, model, editableTarget, Boolean.TRUE));
