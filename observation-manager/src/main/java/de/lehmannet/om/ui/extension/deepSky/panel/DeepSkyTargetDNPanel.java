...
public class DeepSkyTargetDNPanel extends AbstractPanel {
  ...
  private final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.deepSky.DeepSky", Locale.getDefault());	
    ...
    public DeepSkyTargetDNPanel(ObservationManager om, 
    		                    ITarget target, 
		...
		if(    (target != null)
		   && !(target instanceof DeepSkyTargetDN) 
		   ) {
	...
	private void createPanel() {	
	    ...
	    OMLabel LpositionAngle = new OMLabel(this.bundle.getString("panel.dn.label.posAngle"), JLabel.RIGHT, false);
