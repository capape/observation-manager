...
public abstract class AbstractDialog extends OMDialog implements ActionListener, IDialog {	
	...
	protected static PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("ObservationManager", Locale.getDefault());	
	...
	public AbstractDialog(ObservationManager om,
			              AbstractPanel panel) {
	...
	private AbstractDialog(boolean oneButton,
