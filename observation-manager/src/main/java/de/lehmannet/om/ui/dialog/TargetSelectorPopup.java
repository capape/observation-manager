...
public class TargetSelectorPopup extends JDialog implements ActionListener {
	...
	public TargetSelectorPopup(ObservationManager om,
							   String title,
							   String targetType,
							   List preSelectedTargets) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		} /*else if( source instanceof JCheckBox ) {    // Update TableModel
			int row = Integer.parseInt(((JCheckBox)source).getActionCommand());   // We send the row in the action Command
