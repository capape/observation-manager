...
public class TargetStarContainer extends Container {
	...
	// Make this accessible for e.g. VariableStarContainer which will change the label text
	public JLabel LmagnitudeApp = null;
	
    // Stars apparent magnitude (make this accessible for e.g. VariableStarContainer which will change the label text)
    ...
    public TargetStarContainer(ObservationManager om, 
            			       ITarget target, 
	...
	public ISchemaElement createSchemaElement() {
		...
		ITarget t = (ITarget)this.updateTarget();
		if( t == null ) {
			return null;
		} else {
	...
	private void createPanel() {	
		...
		JLabel LstellarClassification = new JLabel(this.bundle.getString("panel.targetStar.label.stellarClassification"));   
	    ...
	    this.stellarClassification.setToolTipText(this.bundle.getString("panel.targetStar.tooltip.stellarClassification"));
	    this.stellarClassification.setEditable(this.editable);
