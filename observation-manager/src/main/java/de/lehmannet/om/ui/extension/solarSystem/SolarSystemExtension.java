...
public class SolarSystemExtension extends AbstractExtension {
	...
	static {
		try {
			SolarSystemExtension.UPDATE_URL = new URL("http://observation.sourceforge.net/extension/solarSystem/update");
		} catch( MalformedURLException m_url ) {
			// Do nothing
		}
	}		
	
	private PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.solarSystem.oalSolarSystemTargetDisplayNames", Locale.getDefault());
	...
	public void reloadLanguage() {
		...
		this.bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.solarSystem.oalSolarSystemTargetDisplayNames", Locale.getDefault());
	...
	public boolean isCreationAllowed(String xsiType) {
		...
		if(   (xsiType.equals("oal:MoonTargetType"))   
	...
	private void initFindingPanels() {
		...
		findingPanels.put(SolarSystemTargetMinorPlanet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.panel.GenericFindingPanel");
	...
	private void initTargetPanels() {
		...
		targetPanels.put(SolarSystemTargetComet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.panel.SolarSystemTargetCometPanel");
		targetPanels.put(SolarSystemTargetMinorPlanet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.panel.SolarSystemTargetMinorPlanetPanel");
		targetPanels.put(SolarSystemTargetMoon.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.panel.SolarSystemTargetMoonPanel");
		targetPanels.put(SolarSystemTargetSun.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.panel.SolarSystemTargetSunPanel");
		targetPanels.put(SolarSystemTargetPlanet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.panel.SolarSystemTargetPlanetPanel");		
	...
	private void initTargetDialogs() {
		...
		targetDialogs.put(SolarSystemTargetComet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.dialog.SolarSystemTargetCometDialog");
		targetDialogs.put(SolarSystemTargetMinorPlanet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.dialog.SolarSystemTargetMinorPlanetDialog");
		targetDialogs.put(SolarSystemTargetMoon.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.dialog.SolarSystemTargetMoonDialog");
		targetDialogs.put(SolarSystemTargetSun.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.dialog.SolarSystemTargetSunDialog");
		targetDialogs.put(SolarSystemTargetPlanet.XML_XSI_TYPE_VALUE, "de.lehmannet.om.ui.extension.solarSystem.dialog.SolarSystemTargetPlanetDialog");
