...
public class SkyChartPreferences extends PreferencesPanel {
  ...
  // Config keys
	...
	private final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.skychart.Skychart", Locale.getDefault());
	...
	private void createPanel() {
        ...
        this.applicationPath = new JTextField(super.configuration.getConfig(SkyChartPreferences.CONFIG_APPLICATION_PATH));
        ...
        this.serverIP = new JTextField(super.configuration.getConfig(SkyChartPreferences.CONFIG_SERVER_IP_KEY, SkyChartPreferences.SERVER_DEFAULT_IP));
        ...
        this.serverPort = new JTextField(super.configuration.getConfig(SkyChartPreferences.CONFIG_SERVER_PORT_KEY, "" + SkyChartPreferences.SERVER_DEFAULT_PORT));
