...
public class DeepSkyTargetNAPanel extends AbstractPanel {
  ...
  private ObservationManager observationManager = null;
    ...
    public DeepSkyTargetNAPanel(ObservationManager om, 
    		                    ITarget target, 
		...
		if(    (target != null)
		   && !(target instanceof DeepSkyTargetNA) 
		   ) {
			throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.deepSky.DeepSkyTargetNA\n");
		}
