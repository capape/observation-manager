...
public class SolarSystemTargetMinorPlanetPanel extends AbstractPanel {
  ...
  private ObservationManager observationManager = null;
    ...
    public SolarSystemTargetMinorPlanetPanel(ObservationManager om, 
                                       ITarget target, 
		...
		if(    (target != null)
	  	   && !(target instanceof SolarSystemTargetMinorPlanet) 
		) {
			throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.solarSystem.SolarSystemTargetMinorPlanet\n");
		}
