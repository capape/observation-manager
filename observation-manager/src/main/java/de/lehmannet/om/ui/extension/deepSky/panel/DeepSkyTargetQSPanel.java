...
public class DeepSkyTargetQSPanel extends AbstractPanel {
  ...
  private ObservationManager observationManager = null;
    ...
    public DeepSkyTargetQSPanel(ObservationManager om, 
    		                    ITarget target, 
		...
		if(    (target != null)
		   && !(target instanceof DeepSkyTargetQS) 
		   ) {
			throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.deepSky.DeepSkyTargetQS\n");
		}
