...
public class SitePanel extends AbstractPanel implements ActionListener {
  ...
  private ISite site = null;
    ...
    public ISchemaElement updateSchemaElement() {
		...
		if(   (longitude.getValue() > 180) 
		   || (longitude.getValue() < -180)
		   ) {
		...
		if(   (latitude.getValue() > 90) 
		   || (latitude.getValue() < -90)
		   ) {
    ...
    private void createPanel() {
        ...
        OMLabel LiauCode = new OMLabel(AbstractPanel.bundle.getString("panel.site.label.iau"), JLabel.RIGHT, false);
        ...
        this.Llatitude = new OMLabel(AbstractPanel.bundle.getString("panel.site.label.latitude"), JLabel.RIGHT, true);
        ...
        OMLabel Ltimezone = new OMLabel(AbstractPanel.bundle.getString("panel.site.label.timezone"), JLabel.RIGHT, true);        
