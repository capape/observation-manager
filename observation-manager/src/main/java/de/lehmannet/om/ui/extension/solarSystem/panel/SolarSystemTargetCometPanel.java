...
public class SolarSystemTargetCometPanel extends AbstractPanel {
 ...
 // private final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.solarSystem.SolarSystem", Locale.getDefault());	
    ...
    public SolarSystemTargetCometPanel(ObservationManager om, 
                                       ITarget target, 
		...
		if(    (target != null)
	  	   && !(target instanceof SolarSystemTargetComet) 
		) {
			throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.solarSystem.SolarSystemTargetComet\n");
		}
