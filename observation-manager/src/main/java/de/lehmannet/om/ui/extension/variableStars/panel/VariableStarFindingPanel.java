...
public class VariableStarFindingPanel extends AbstractPanel implements IFindingPanel {	
  ...
  // Config keys
    ...
    public VariableStarFindingPanel(ObservationManager om,
    						        IFinding finding, 
							        ISession s,
							        ITarget t,
		...
		if(    (finding != null)
		   && !(finding instanceof FindingVariableStar) ) {
			//throw new IllegalArgumentException("Passed IFinding must derive from de.lehmannet.om.extension.variableStars.FindingVariableStar\n");
			
			// Create minimalistic FindingVariableStar from given IFinding (must be a IFinding instance due to parameter definition)
	...
	private void createPanel() {
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LchartDate = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.chartDate"), JLabel.LEFT, true);
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LnonAAVSOchart = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.nonAAVSOchart"), JLabel.LEFT, false);
        ...
        constraints.fill = GridBagConstraints.HORIZONTAL;
        constraints.anchor = GridBagConstraints.EAST;
        OMLabel Lmagnitude = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.magnitude"), JLabel.RIGHT, true);
        ...
        this.magnitudeFainterThan.setToolTipText(this.bundle.getString("panel.variableStarFinding.tooltip.magnitudeFainterThan"));
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LmagnitudeFainterThan = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.magnitudeFainterThan"), JLabel.LEFT, false);
        LmagnitudeFainterThan.setToolTipText(this.bundle.getString("panel.variableStarFinding.tooltip.magnitudeFainterThan"));
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LmagnitudeUncertain = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.magUncertain"), JLabel.LEFT, false);
        ...
        constraints.fill = GridBagConstraints.HORIZONTAL;
        constraints.anchor = GridBagConstraints.EAST;
        OMLabel LcompStars = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.compStars"), JLabel.RIGHT, true);
        ...
        this.comparismSequenceProblem.setToolTipText(this.bundle.getString("panel.variableStarFinding.tooltip.comparismSeqProblem"));
        constraints.fill = GridBagConstraints.NONE;
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LcomparismSequenceProblem = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.comparismSeqProblem"), JLabel.LEFT, false);
        LcomparismSequenceProblem.setToolTipText(this.bundle.getString("panel.variableStarFinding.tooltip.comparismSeqProblem"));
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LbrightSky = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.brightSky"), JLabel.LEFT, false);
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel Lclouds = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.clouds"), JLabel.LEFT, false);
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LpoorSeeing = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.poorSeeing"), JLabel.LEFT, false);
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LnearHorizion = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.nearHorizon"), JLabel.LEFT, false);
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LunusualActivity = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.unusualActivity"), JLabel.LEFT, false);
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel Loutburst = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.outburst"), JLabel.LEFT, false);
        ...
        this.starIdentificationUncertain.setToolTipText(this.bundle.getString("panel.variableStarFinding.tooltip.starIdentificationUncertain"));
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LstarIdentificationUncertain = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.starIdentificationUncertain"), JLabel.LEFT, false);
        LstarIdentificationUncertain.setToolTipText(this.bundle.getString("panel.variableStarFinding.tooltip.starIdentificationUncertain"));
        ...
        constraints.anchor = GridBagConstraints.WEST;
        OMLabel LfaintStar = new OMLabel(this.bundle.getString("panel.variableStarFinding.label.faintStar"), JLabel.LEFT, false);
	...
	private List getComparismStars() {
		...
		if(   (compStarText == null)
		   || ("".equals(compStarText.trim()))
		   ) {
			return null;
		}
		
		ArrayList result = new ArrayList(4);
		StringTokenizer tokenizer = new StringTokenizer(compStarText, VariableStarFindingPanel.DELIMITER_COMPARISM_STAR);
	...
	private void writeToCache() {
    	...
    	if(   (super.isEditable())
    	   && (this.finding != null)
    	   && (Boolean.valueOf(this.om.getConfiguration().getConfig(VariableStarsPreferences.CONFIG_CACHE_ENABLED)).booleanValue())
    	   ) {
        	...
        	config.setConfig(VariableStarFindingPanel.CONFIG_LAST_COMPARISM_STARS, this.comparismStars.getText());  // Use JTextField here so that we don't need to build up string again
        	if( this.nonAAVSOchart.isSelected() ) {
        		config.setConfig(VariableStarFindingPanel.CONFIG_LAST_NONAAVSOCHART, Boolean.toString(this.finding.isNonAAVSOchart()));	
        	} else {
	...
	private void loadFromCache() {
		...
		if(   (super.isEditable())
		   && (Boolean.valueOf(this.om.getConfiguration().getConfig(VariableStarsPreferences.CONFIG_CACHE_ENABLED)).booleanValue())
		   && (targetName.equals(this.om.getConfiguration().getConfig(VariableStarFindingPanel.CONFIG_LAST_STAR, "").toLowerCase()))
		   ) {
			Configuration config = this.om.getConfiguration();	
			
			String lastChartDate = config.getConfig(VariableStarFindingPanel.CONFIG_LAST_CHARTDATE);
			if(   (lastChartDate != null)
			   && !("".equals(lastChartDate.trim()))
			   ) {
			...
			if(   (lastCompStars != null)
			   && !("".equals(lastCompStars.trim()))
			   ) {
			...
			if(   (lastNonAAVSOChart != null)
			   && !("".equals(lastNonAAVSOChart.trim()))
			   ) {
