...
public class EyepiecePanel extends AbstractPanel implements ItemListener {
  ...
  private IEyepiece eyepiece = null;
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (source == this.zoomEyepiece) {
        	if (e.getStateChange() == ItemEvent.DESELECTED) {
        		...
        		this.LfocalLengthName.setToolTipText(AbstractPanel.bundle.getString("panel.eyepiece.tooltip.focalLength"));
        		...
        		this.LfocalLengthName.setToolTipText(AbstractPanel.bundle.getString("panel.eyepiece.tooltip.minFocalLength"));
        	}
    ...
    public ISchemaElement updateSchemaElement() {
    	...
    	if( this.zoomEyepiece.isSelected() ) {
    		...
    		if( maxFL < focalLength ) {
    			super.createWarning(AbstractPanel.bundle.getString("panel.eyepiece.warning.maxFocalLengthSmallerFocalLength"));
    			return null;    			    			
    		}    	    		
    	}
	...
	public ISchemaElement createSchemaElement() {
		...
		// Create eyepiece
		this.eyepiece = new Eyepiece(modelName, 
				                     focalLength);
    ...
    private void createPanel() {
        ...
        OMLabel LvendorName = new OMLabel(AbstractPanel.bundle.getString("panel.eyepiece.label.vendor"), JLabel.RIGHT, false);        
        ...
        this.LmaxFocalLengthName = new OMLabel(AbstractPanel.bundle.getString("panel.eyepiece.label.maxFocalLength"), JLabel.RIGHT, true);        
        ...
        JLabel LapparentFOVName = new OMLabel(AbstractPanel.bundle.getString("panel.eyepiece.label.appearendFoV"), false);
