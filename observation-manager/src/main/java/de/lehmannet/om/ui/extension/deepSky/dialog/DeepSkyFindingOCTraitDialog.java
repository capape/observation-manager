...
public class DeepSkyFindingOCTraitDialog extends OMDialog {
	...
	final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.deepSky.DeepSky", Locale.getDefault());
	
	private TraitPanel panel = null;
	
	public DeepSkyFindingOCTraitDialog(ObservationManager om, String imagePath, Character character) {
