...
public class SolarSystemTargetSunPanel extends AbstractPanel {
  ...
  //private final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.solarSystem.SolarSystem", Locale.getDefault());	
    ...
    public SolarSystemTargetSunPanel(ObservationManager om, 
                                     ITarget target, 
                                     IObservation o,
		...
		if(    (target != null)
	  	   && !(target instanceof SolarSystemTargetSun) 
		) {
			throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.solarSystem.SolarSystemTargetSun\n");
		}
