...
public class FindingContainer extends Container implements MouseListener {
    ...
    public FindingContainer(ObservationManager om,
    						IFinding finding,     	
							ISession session,
						    boolean editable) {
		...
		this.language = new LanguageBox(om.getConfiguration().getConfig(ObservationManager.CONFIG_CONTENTDEFAULTLANG), true);
	...
	private void createContainer() {
        ...
        JLabel Llanguage = new JLabel(this.bundle.getString("panel.session.label.language"), JLabel.RIGHT);
