...
public class ObservationTableModel extends AbstractSchemaTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if(   (super.elements == null)
           || (rowIndex < 0)			// Might happen during load of an XML file
           ) {
            return value;
        }
        ...
        switch (columnIndex) {
            ...
            case 3 : {
		                value = this.om.getExtensionLoader().getSchemaUILoader().getDisplayNameForType(observation.getTarget().getXSIType());
		                break; 
		             }            
            case 4 : {
