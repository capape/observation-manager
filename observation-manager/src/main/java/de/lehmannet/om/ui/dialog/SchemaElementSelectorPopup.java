...
public class SchemaElementSelectorPopup extends OMDialog implements ActionListener {
	...
	public SchemaElementSelectorPopup(ObservationManager om,
							          String title,
							          String xsiType,
							          List preSelectedElements,
							          boolean multipleSelection,
							          int schemaElement) throws IllegalArgumentException, NoSuchElementException {   // See SchemaElementConstants
		...
		switch( schemaElement ) {
			...
			default :  {
				throw new IllegalArgumentException("Passed schemaElement ID was wrong. Use SchemaElementConstants for retriving ID.");     // SchemaElementID was wrong
			}
		}
		...
		this.tableModel = new ExtendedSchemaTableModel(elements, schemaElement, xsiType, multipleSelection, preSelectedElements);
