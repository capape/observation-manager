...
public class ObserverDialog extends AbstractDialog {
	...
	public ObserverDialog(ObservationManager om,
			              IObserver editableObserver) {
		...
		if( editableObserver == null ) {
			...
			super.setTitle(AbstractDialog.bundle.getString("dialog.observer.titleEdit") + " " + editableObserver.getDisplayName());
		}				
