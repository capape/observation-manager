...
public class VariableStarTargetDialog extends AbstractDialog implements ITargetDialog {
	...
	public VariableStarTargetDialog(ObservationManager om,
		...
		if( editableTarget == null ) {
			...
			super.setTitle(this.bundle.getString("dialog.variableTarget.titleEdit") + " " + editableTarget.getDisplayName());
		}				
