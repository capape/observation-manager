...
public class EyepieceDialog extends AbstractDialog {
	...
	public EyepieceDialog(ObservationManager om,
			              IEyepiece editableEyepiece) {
		...
		if( editableEyepiece == null ) {
			...
			super.setTitle(AbstractDialog.bundle.getString("dialog.eyepiece.titleEdit") + " " + editableEyepiece.getDisplayName());
		}			
