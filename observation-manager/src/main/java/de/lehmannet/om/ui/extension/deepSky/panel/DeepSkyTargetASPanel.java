...
public class DeepSkyTargetASPanel extends AbstractPanel {
  ...
  private final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.deepSky.DeepSky", Locale.getDefault());	
    ...
    public DeepSkyTargetASPanel(ObservationManager om, 
    		                    ITarget target, 
		...
		if(    (target != null)
		   && !(target instanceof DeepSkyTargetAS) 
		   ) {
			throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.deepSky.DeepSkyTargetAS\n");
		}
