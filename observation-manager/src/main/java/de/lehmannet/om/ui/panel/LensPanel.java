...
public class LensPanel extends AbstractPanel {
  ...
  private ILens lens = null;
    ...
    private void createPanel() {
        ...
        OMLabel LvendorName = new OMLabel(AbstractPanel.bundle.getString("panel.lens.label.vendor"), JLabel.RIGHT, false);        
