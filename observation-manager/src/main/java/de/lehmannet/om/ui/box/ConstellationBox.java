...
public class ConstellationBox extends JComboBox {
	...
	private static final Constellation cache[] = new Constellation[] {
					                                                   ...
					                                                   Constellation.CORONA_AUSTRALIS,
					                                                   ...
					                                                   Constellation.PISCES_AUSTRINUS,
					                                                   ...
					                                                   Constellation.TRIANGULUM_AUSTRALIS,
					                                                   Constellation.TRIANGULUM,
					                                                   Constellation.TUCANA,
					                                                   Constellation.URSA_MAIOR,
	...
	/*public static String getAbbreviation(String name) {
		...
		for(int i=0; i < ConstellationBox.cache.length; i++) {
			if( ConstellationBox.cache[i].getName().toLowerCase().trim().equals(name.toLowerCase().trim()) ) {
				return ConstellationBox.cache[i].getAbbreviation();
			}
		}
	...
	/*public static String getConstellationName(String abbreviation) {
		...
		if(   (abbreviation == null)
		   || ("".equals(abbreviation.trim()))
		   ) {
			return null;
		}
		
		for(int i=0; i < ConstellationBox.cache.length; i++) {
			if( ConstellationBox.cache[i].getAbbreviation().equals(abbreviation) ) {
				return ConstellationBox.cache[i].getName();
			}
		}
