...
public class DeepSkyTargetContainer extends Container {
  ...
  private final PropertyResourceBundle bundle = (PropertyResourceBundle)ResourceBundle.getBundle("de.lehmannet.om.ui.extension.deepSky.DeepSky", Locale.getDefault());	
    ...
    public DeepSkyTargetContainer(ObservationManager om,
    		                      ITarget target, 
    					     	  boolean editable) {      	
    	
		if( target != null ) {
			if( !(target instanceof DeepSkyTarget) ) {
				throw new IllegalArgumentException("Passed ITarget must derive from de.lehmannet.om.extension.deepSky.DeepSkyTarget\n");
			}
    ...
    public ITarget updateTarget(ITarget target) {    	
    	...
    	try {
			...
			this.observationManager.createWarning(this.bundle.getString("panel.warning.smallDiameterNoNumber"));
			return null;
		}
   ...
   // 	}
    	...
    	try {
			...
			this.observationManager.createWarning(this.bundle.getString("panel.warning.largeDiameterNoNumber"));
			return null;
		}
   ...
   // 	}    	
		...
		try {
			...
			this.observationManager.createWarning(this.bundle.getString("panel.observation.warning.noNumberSB"));
			return null;			
		}
	...
	private void createContainer() {
        ...
        constraints.fill = GridBagConstraints.NONE;
        OMLabel LsurfaceBrightness = new OMLabel(this.bundle.getString("container.target.label.surfaceBrightness"), JLabel.RIGHT, false);
        ...
        constraints.fill = GridBagConstraints.HORIZONTAL;
        this.surfaceBrightness = new SurfaceBrightnessContainer(this.editable, new String[] {SurfaceBrightness.MAGS_SQR_ARC_MIN, SurfaceBrightness.MAGS_SQR_ARC_SEC});
        ...
        constraints.fill = GridBagConstraints.NONE;
        OMLabel LlargeDiameter = new OMLabel(this.bundle.getString("container.target.label.largeDiameter"), JLabel.RIGHT, false);        
