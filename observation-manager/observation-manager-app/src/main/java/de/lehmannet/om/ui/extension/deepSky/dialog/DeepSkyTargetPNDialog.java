...
public class DeepSkyTargetPNDialog extends AbstractDialog implements ITargetDialog {
    ...
    public DeepSkyTargetPNDialog(ObservationManager om, ObservationManagerModel model,ITarget editableTarget) {

        super(om, new DeepSkyTargetPNPanel(om, model, editableTarget, Boolean.TRUE));
