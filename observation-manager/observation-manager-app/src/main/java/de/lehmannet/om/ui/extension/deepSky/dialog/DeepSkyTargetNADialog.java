...
public class DeepSkyTargetNADialog extends AbstractDialog implements ITargetDialog {
    ...
    public DeepSkyTargetNADialog(ObservationManager om, ObservationManagerModel model,ITarget editableTarget) {

        super(om, new DeepSkyTargetNAPanel(om, model, editableTarget, Boolean.TRUE));
