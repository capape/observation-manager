...
public class DeepSkyTargetSC extends DeepSkyTarget {
    ...
    /**
     * Constructs a new instance of a DeepSkyTargetSC from a given DOM target Element.<br>
    ...
    public DeepSkyTargetSC(Node targetElement, IObserver... observers) throws SchemaException {
        ...
        NodeList children = target.getElementsByTagName(DeepSkyTargetSC.XML_ELEMENT_POSITIONANGLE);
     ...
     * @param datasource
     *            The datasource of the star cloud
     */
     ...
     *            The name of the star cloud
     * @param observer
     *            The observer who is the originator of the star cloud
     */
    ...
    public void addToXmlElement(Element element) {
        ...
        Element e_DSTarget = this.createXmlDeepSkyTargetElement(element, DeepSkyTargetSC.XML_XSI_TYPE_VALUE);
