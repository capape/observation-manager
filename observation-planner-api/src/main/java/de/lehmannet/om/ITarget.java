...
/**
 * An ITarget describes a celestial object which might be interessting for
 * astronomical observation.<br>
 * An ITraget is a very general description of an astronomical object,
 * representing just the objects name, the celestial position and some optional
 * alias names. The optional names might be used for colloquial names of a
...
public interface ITarget extends ISchemaElement, IExtendableSchemaElement {
     ...
     * Example:<br>
     * &lt;target xsi:type="oal:deepSkyGX"&gt;<i>More stuff goes
     * here</i>&lt;/target&gt;
     */
     ...
     * &lt;name&gt;<code>Target name goes here</code>&lt;/name&gt; <i>More stuff
     * goes here</i> &lt;/target&gt;
     */
     ...
     * &lt;alias&gt;<code>Target alias name goes here</code>&lt;/alias&gt; <i>More
     * stuff goes here</i> &lt;/target&gt;
     */
    public static final String XML_ELEMENT_ALIASNAME = "alias";

    /**
     * Constant for XML representation: Celestial constellation where the target can
     * be found.<br>
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i>
    ...
    /**
     * Constant for XML representation: Datasource that is the origin of this
     * target.<br>
     ...
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;notes&gt;<code>Notes go here</code>&lt;/notes&gt; <i>More stuff goes
     * here</i> &lt;/target&gt;
     */
     ...
     * @return Returns <code>true</code> if the alias name could be added to the
     *         target.
     */
     ...
     *         not be found in the targets alias name list.
     */
