...
/**
 * An ITarget describes a celestial object which might be interessting for astronomical observation.<br>
 * An ITraget is a very general description of an astronomical object, representing just the objects name, the celestial
...
public interface ITarget extends ISchemaElement, IExtendableSchemaElement {
     ...
     */
    String XML_ELEMENT_TARGET = "target";
     ...
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;name&gt;<code>Target name goes here</code>&lt;/name&gt; <i>More stuff goes
     * here</i> &lt;/target&gt;
     */
     ...
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;name&gt;<code>Target name goes here</code>&lt;/name&gt;
     * &lt;alias&gt;<code>Target alias name goes here</code>&lt;/alias&gt; <i>More stuff goes here</i> &lt;/target&gt;
     */
    String XML_ELEMENT_ALIASNAME = "alias";

    /**
     * Constant for XML representation: Celestial constellation where the target can be found.<br>
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;constellation&gt;<code>Constellationname goes here</code>&lt;/constellation&gt;
     * <i>More stuff goes here</i> &lt;/target&gt;
     */
    String XML_ELEMENT_CONSTELLATION = "constellation";
     ...
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;datasource&gt;<code>Datasource goes here</code>&lt;/datasource&gt; <i>More stuff
     * goes here</i> &lt;/target&gt;
     */
    String XML_ELEMENT_DATASOURCE = "datasource";

    /**
     * Constant for XML representation: Additional notes to the target.<br>
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;notes&gt;<code>Notes go here</code>&lt;/notes&gt; <i>More stuff goes here</i>
     * &lt;/target&gt;
     */
    String XML_ELEMENT_NOTES = "notes";
