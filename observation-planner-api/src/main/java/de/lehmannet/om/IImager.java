...
/**
 * An IImager describes a camera. The model name is a mandatory field which has
 * to be set.
 * 
...
public interface IImager extends ISchemaElement, IExtendableSchemaElement, IEquipment {
     ...
     * This is more or less the same as in IExtendableSchemaElement.java but as
     * extending IExtendableSchemaElement would cause us to implement
     * <code>String getXSIType()</code> (which we can't do here) we define this
     * constant again in IImager.
     */
     ...
     * &lt;imager&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;type&gt;<code>Type goes here</code>&lt;/type&gt; <i>More stuff goes
     * here</i> &lt;/imager&gt;
     */
     ...
     * &lt;imager&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;remarks&gt;<code>Vendor name goes here</code>&lt;/remarks&gt; <i>More
     * stuff goes here</i> &lt;/imager&gt;
     */
