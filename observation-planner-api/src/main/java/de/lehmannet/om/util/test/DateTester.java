...
public class DateTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Converted Julian Date: " + new Date(convertedJulianDate.getTimeInMillis())
                + "\t(Timezone = " + convertedJulianDate.getTimeZone().getDisplayName() + ")");
        ...
        System.out.println("Converted ISO8601 Date: " + new Date(converted8601Date.getTimeInMillis()) + "\t(Timezone = "
