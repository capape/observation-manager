...
/**
 * An IScope describes an optical instrument which can be used for astronomical
 * observations.<br>
 * An IScope must have an aperture and a model name, as well as either a
...
public interface IScope extends ISchemaElement, IEquipment {
     ...
     * &lt;model&gt;<code>Scopes model name goes here</code>&lt;/model&gt; <i>More
     ...
     * &lt;scope&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;type&gt;<code>Scopes type goes here</code>&lt;/type&gt; <i>More stuff
     * goes here</i> &lt;/scope&gt;
     */
     ...
     * &lt;scope&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;vendor&gt;<code>Scopes vendor goes here</code>&lt;/vendor&gt; <i>More
     * stuff goes here</i> &lt;/scope&gt;
     */
     ...
     * Example:<br>
     * &lt;scope&gt; <br>
     * <i>More stuff goes here</i> &lt;orientation erect=true truesided=true /&gt;
     * <i>More stuff goes here</i> &lt;/scope&gt;
     */
    ...
    /**
     * Constant for XML representation: If magnification is given, the true field of
     * view can be passed additionally.<br>
     * Example:<br>
     * &lt;scope&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;magnification&gt;<code>Scopes magnification goes here</code>&lt;/magnification&gt;
     ...
     * @return Returns the element given as parameter with this Scope as child
     *         element.<br>
     ...
     * @return <b>true</b> if new lightGrasp value could be set. If <b>false</b> is
     *         returned the new lightGrasp value was < 0.0 or > 1.0.
     */
