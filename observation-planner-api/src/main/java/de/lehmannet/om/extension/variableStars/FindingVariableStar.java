...
public class FindingVariableStar extends Finding {
    ...
    public void setComparismStars(List comparismStars) throws IllegalArgumentException {
        ...
        if ((comparismStars == null) || (comparismStars.size() == 0)) {
     ...
     *                      comparism star
     * @return <b>true</b> if the new comparism star could be added, <b>false</b> if
     *         the operation fails, because e.g. the given comparism star is
     *         <code>null</code> or an empty string
     */
     ...
     *         <b>false</b> if the operation fails, because the list was
     *         <code>null</code> or empty<br>
     *         <b>false</b> is also returned the existing list is not changed at
     *         all.
     */
