...
public class DeepSkyTestUtil {
    ...
    public IObservation createDeepSkyObservation() {                    
        ...
        IObservation observation = new Observation(new GregorianCalendar(2004,01,01,22,00),
                                                   new GregorianCalendar(2004,01,01,22,10),                                                   
                                                   5.0f,
                                                   new SurfaceBrightness(19.5f, SurfaceBrightness.MAGS_SQR_ARC_SEC),
                                                   4,
                                                   70.3f,
                                                   target1,
                                                   observer1,
    ...
    public IObservation createDeepSkyObservation2() {               
        ...
        IObservation observation = new Observation(new GregorianCalendar(2004,01,01,22,15),
                                                   new GregorianCalendar(2004,01,01,22,30),
                                                   5.0f,
                                                   new SurfaceBrightness(14.7f, SurfaceBrightness.MAGS_SQR_ARC_SEC),
                                                   2,
                                                   150.0f,
                                                   target2,
                                                   observer1,
    ...
    public IObservation createDeepSkyObservation3() {                  
        ...
        IObservation observation = new Observation(new GregorianCalendar(2004,01,02,22,00),
                                                   new GregorianCalendar(2004,01,02,22,30),
                                                   target3,
                                                   observer2,
                                                   finding3                               
                                                   );                                                                           
    ...
    public IFinding createFinding() {
        ...
        DeepSkyFinding finding = new DeepSkyFinding("Looks twisted",
                                                    3);
    ...
    public IFinding createThirdFinding() {
        ...
        DeepSkyFinding finding = new DeepSkyFinding("Wow!",
                                                    4);
    ...
    public IFinding createSecondFinding() {
        ...
        DeepSkyFinding finding = new DeepSkyFinding("Hey there're two!",
                                                    3);
    ...
    public ISession createSession() {
        ...
        ISession session = new Session(new GregorianCalendar(2004,01,01,22,00),
                                       new GregorianCalendar(2004,01,01,23,30),
									   this.site1
                                       );
    ...
    public IEyepiece createEyepiece() {
        ...
        IEyepiece eyepiece = new Eyepiece("Nagler",
                                          31
                                         );               
    ...
    public IEyepiece createSecondEyepiece() {
        ...
        IEyepiece eyepiece = new Eyepiece("Speers Waler",
                                          10
                                         );                             
    ...
    public IFilter createFilter() {
        ...
        IFilter filter = new Filter("Meade Narrowband",
                                    IFilter.FILTER_TYPE_COLOR);                             
    ...
    public IScope createScope() {
        ...
        IScope scope = new Scope("Meade Starfinder 10\"",
                                 254,
                                 1140
                                 );
    ...
    public ISite createSecondSite() {
        ...
        ISite site = new Site("Dossenheim",
                              new Angle(8.657, Angle.DEGREE),
                              new Angle(49.45, Angle.DEGREE),
                              2 
                              );
    ...
    public IObserver createObserver() {
        ...
        IObserver observer = new Observer("John", 
                                          "Doe");
    ...
    public IObserver createSecondObserver() {
        ...
        IObserver observer = new Observer("Hans", 
                                          "Mustermann");
    ...
    public ITarget createDeepSkyTarget() {
        ...
        DeepSkyTargetDS target = new DeepSkyTargetDS("A double star",
                                                   "WU DC");
    ...
    public ITarget createSecondDeepSkyTarget(IObserver observer) {
        ...
        DeepSkyTargetOC target = new DeepSkyTargetOC("M45",
                                           observer);
    ...
    public ITarget createThirdDeepSkyTarget() {
        ...
        DeepSkyTargetGC target = new DeepSkyTargetGC("M13",
                                           "Messier Catalogue");
