...
/**
 * An ISession can be used to link several observations together. Typically a
 * session would describe an observation night, where several observations took
 * place. Therefore an ISession requires two mandatory fields: a start date and
...
public interface ISession extends ISchemaElement {
     ...
     * &lt;begin&gt;<code>Sessions start date goes here</code>&lt;/begin&gt; <i>More
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;end&gt;<code>Sessions end date goes here</code>&lt;/end&gt; <i>More stuff
     * goes here</i> &lt;/session&gt;
     */
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;site&gt;<code>Sessions site goes here</code>&lt;/site&gt; <i>More stuff
     * goes here</i> &lt;/session&gt;
     */
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;coObserver&gt;<code>Sessions coObserver goes here</code>&lt;/coObserver&gt;
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;weather&gt;<code>Sessions weather goes here</code>&lt;/weather&gt;
     * <i>More stuff goes here</i> &lt;/session&gt;
     */
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;equipment&gt;<code>Sessions equipment goes here</code>&lt;/equipment&gt;
     * <i>More stuff goes here</i> &lt;/session&gt;
     */
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;comments&gt;<code>Sessions comments go here</code>&lt;/comments&gt;
     * <i>More stuff goes here</i> &lt;/session&gt;
     */
     ...
     * Since COMAST 1.5 it is possible to add a language description to a session
     * element. This language description give the language in which all session
     ...
     * &lt;session&gt; <br>
     * <i>More stuff goes here</i>
     * &lt;image&gt;<code>Relative path to image</code>&lt;/image&gt; <i>More stuff
     * goes here</i> &lt;/session&gt;
     */
     ...
     * Might return <code>null</code> if no weather conditions were addedt to this
     * session.
     * 
