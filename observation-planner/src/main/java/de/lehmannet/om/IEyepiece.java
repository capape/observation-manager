...
/**
 * An IEyepiece describes a optical eyepiece. The model name and the focalLength
 * are mandatory fields which have to be set.
 * 
...
public interface IEyepiece extends ISchemaElement, IEquipment {
     ...
     */
    public de.lehmannet.om.Angle getApparentFOV();

    // -------------------------------------------------------------------
    /**
     * Returns the focal length of this eyepiece. The focal length of the telescope
     * divided by the focal length of the eyepiece equals the amplification.
     * 
     ...
     */
    public boolean setApparentFOV(de.lehmannet.om.Angle apparentFOV);
