...
public class Session extends SchemaElement implements ISession {
    ...
    public Session(Node session, IObserver[] observers, ISite[] sites)
        ...
        getCoObserverLink(observers, sessionElement);
    ...
    private void getLanguages(Element sessionElement) {
    ...
    private void getCoObserverLink(IObserver[] observers, Element sessionElement) throws SchemaException {
        Element child;
        NodeList children;
    ...
    private void getId(Element sessionElement) throws SchemaException {
        // Get mandatory ID
