 ...
 * The GenericFinding class stores a description of the findings and provides
 * simple access to this description field.
 * 
...
public class GenericFinding extends Finding {
     ...
     * Checks if this GenericFinding and the given Object are equal. Two
     * GenericFinding are equal if both return the same string from their toString()
     * method and both XSI types are equal.<br>
     * 
     * @param obj The Object to compare this GenericFinding with.
     * @return <code>true</code> if both Objects are instances from class
     *         GenericFinding, their XSI type is equal and their fields contain the
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.toString().equals(obj.toString())) && (this.getXSIType().equals(((IFinding) obj).getXSIType()))) {
            return true;
        }
    ...
    // -------------------------------------------------------------------
    /**
     * Adds this GenericFinding to an given parent XML DOM Element. The
     * GenericFinding Element will be set as a child element of the passed Element.
     * 
     * @param parent The parent element for this GenericFinding
     * @return Returns the Element given as parameter with this GenericFinding as
     *         child Element.<br>
    ...
    public Element addToXmlElement(Element parent) {
        ...
        // Set XSI:Type
        e_Finding.setAttribute(IExtendableSchemaElement.XML_XSI_TYPE, GenericFinding.XML_XSI_TYPE_VALUE);
