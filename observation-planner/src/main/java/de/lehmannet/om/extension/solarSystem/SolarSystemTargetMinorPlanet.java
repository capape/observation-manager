...
public class SolarSystemTargetMinorPlanet extends SolarSystemTarget {
     ...
     */
    public SolarSystemTargetMinorPlanet(String name, IObserver observer) throws SchemaException {
     ...
     * @throws SchemaException if a parameter was <code>null</code>
     */
    public SolarSystemTargetMinorPlanet(String name, String datasource) throws SchemaException {
