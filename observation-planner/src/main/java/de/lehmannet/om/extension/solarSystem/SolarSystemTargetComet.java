...
public class SolarSystemTargetComet extends SolarSystemTarget {
    ...
    // -------------------------------------------------------------------
    /**
     * Constructs a new instance of a SolarSystemTargetComet from a given DOM target
     * Element.<br>
     ...
     */
    public SolarSystemTargetComet(String name, IObserver observer) throws SchemaException {
     ...
     * @throws SchemaException if a parameter was <code>null</code>
     */
    public SolarSystemTargetComet(String name, String datasource) throws SchemaException {
