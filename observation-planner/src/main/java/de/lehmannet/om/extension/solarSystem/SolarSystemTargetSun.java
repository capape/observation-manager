...
public class SolarSystemTargetSun extends SolarSystemTarget {
    ...
    // -------------------------------------------------------------------
    /**
     * Constructs a new instance of a SolarSystemTargetSun from a given DOM target
     * Element.<br>
     ...
     */
    public SolarSystemTargetSun(String name, IObserver observer) throws SchemaException {
     ...
     * @throws SchemaException if a parameter was <code>null</code>
     */
    public SolarSystemTargetSun(String name, String datasource) throws SchemaException {
