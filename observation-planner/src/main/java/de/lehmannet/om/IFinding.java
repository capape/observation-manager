...
/**
 * A IFinding describes the impressions a observer had during a observation of
 * an astronomical object.<br>
 * A IFinding is a very general description without observation or object
 * typical parameters. Subclasses of IFinding have to provide a specialised way
 * to describe different astronmical observartions or obejects (e.g. variable
 * Stars, DeepSky, Planets...).
 * 
...
public interface IFinding extends ISchemaElement, IExtendableSchemaElement {
     ...
     * Since COMAST 1.5 it is possible to add a language description to a finding
     * element. This language description give the language in which all finding
     * related entrys were made.<br>
    ...
    // -------------------------------------------------------------------
    /**
     * Adds the IFinding implementation to an given parent XML DOM Element. The
     * finding Element will be set as a child element of the passed Element.<br>
     * Example:<br>
     * &lt;parentElement&gt;<br>
     * &lt;result&gt;<br>
    ...
    // -------------------------------------------------------------------
    /**
     * Returns the description of the IFinding. The string describes the impressions
     * the observer had during the observation of an object.
     * 
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the description of the IFinding. The string should describe the
    ...
    // -------------------------------------------------------------------
    /**
     * Returns the language in which this finding is described as ISO language
     * string. E.g. de=German, fr=French, ...<br>
     * Might return <code>null</code> if no language was set for this finding.
     * 
     * @return Returns a ISO language code that represents the finding describtion
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the language in which this finding is described. String must be given as
    ...
    // -------------------------------------------------------------------
    /**
     * Returns <code>true</code> if the target was seen with this finding or not. As
     * findings might be created to document that an object was not seen this flag
